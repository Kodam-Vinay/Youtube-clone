...
export const SEARCH_RESULTS_API = `https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=30&q=vinay&maxResults=30&key=${process.env.REACT_APP_YOUTUBE_API_KEY}`;
